export const PORTRAIT_ROOT = '/src/assets/portrait/';
...
export const NPC_DATA = {
    npc_a: {
        ...
        portraits: { default: 'npc_A_00.png', smile: 'npc_A_01.png', angry: 'npc_A_02.png', surprised: 'npc_A_03.png' }
    },
    detective_kang: {
        id: 'detective_kang',
        name: '강 형사',
    ...
    bokeo: {
        ...
        portraits: { default: 'npc_bokeo_00.png', glare: 'npc_bokeo_01.png', smirk: 'npc_bokeo_02.png', confess: 'npc_bokeo_03.png' }
    },
    galchi: {
        id: 'galchi',
        name: '청갈치',
        initialPortrait: 'npc_galchi_00.png',
        portraits: { default: 'npc_galchi_00.png', smirk: 'npc_galchi_01.png', serious: 'npc_galchi_02.png' }
    },
    bingeo: {
        id: 'bingeo',
        name: '곽빙어',
...
export const resolvePortraitPath = (filename) => {
    if (!filename) return null;
    if (filename.startsWith('http') || filename.startsWith('/')) return filename;
    return `${PORTRAIT_ROOT}${filename}`;
};

export const getNpcDataResolved = () => {
