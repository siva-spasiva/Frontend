export const ITEM_DEFINITIONS = {
    ...
    item006: {
        ...
        flavorText: '모두 [뻐끔 뻐끔]에게 [뻐끔] 하세요! - 전광어 목사',
        type: 'normal',
        icon: '🍹',
        consumable: true,
        effect: { fishLevel: 10 },
    ...
    item012: {
        id: 'item012',
        name: '한쪽 신발',
        description: '누군가의 한쪽 신발.',
        flavorText: '이게 여기에 있는 이유가 뭘까.',
        type: 'key_item',
        icon: '👟',
    },
    item013: {
        id: 'item013',
        name: '냉동고의 명찰',
        description: '신선한 물고기에 박혀있는 명찰. 냉동고에서 주웠다. 구복치라고 적혀 있다.',
        flavorText: '끔찍한 상상이 떠오른다.',
        type: 'key_item',
        icon: '📜',
    },
    item014: {
        ...
        name: '보트 키',
        description: '보트의 키.',
        flavorText: '배의 열쇠. 보트를 타고 나갈 수 있을 것 같다.',
        type: 'key_item',
        icon: '🔑',
    },
    item015: {
        id: 'item015',
        name: '얼음 덩어리',
        description: '차가운 얼음 덩어리. 냉동고에서 주웠다.',
        flavorText: '뭐 이런걸 다 주웠어? - 청갈치',
        type: 'normal',
        icon: '🧊',
    },
    item016: {
        id: 'item016',
        name: '냉동 식재료',
        description: '냉동 식재료. 냉동고에서 주웠다.',
        flavorText: '얼마나 냉동시켜놨는지, 다 물러서 먹기도 힘들것 같아.',
        type: 'normal',
        icon: '🥬',
    },
    item017: {
    ...
    item019: {
        id: 'item019',
        name: '교리가 적힌 노트',
        description: '교리가 적힌 공부용 노트.',
        flavorText: '누군가 공부하다 잠든 모양이다. 침이 흘러 있다...',
        type: 'normal',
        icon: '📜',
    },
    item020: {
    ...
    item021: {
        id: 'item021',
        name: '허름한 티셔츠',
        description: '허름한 티셔츠. 덜 말랐다.',
        flavorText: '제발 세탁하고나서 빨리 가져가. 안그러면 내가 가져간다. - 곽빙어',
        type: 'normal',
        icon: '👕',
    },
    item022: {
        id: 'item022',
        name: '술병',
        description: '술병. 뚜껑이 열린 채 오래 지나서 말라있다.',
        flavorText: '',
        type: 'normal',
        icon: '🍷',
    },
    item023: {
        id: 'item023',
        name: '썰린 고기',
        description: '썰린 고기. 조리실에서 몰래 챙겼다.',
        flavorText: '그닥 신선해보이지는 않는다.',
        type: 'normal',
        icon: '🥩',
    },
    item024: {
        id: 'item024',
        name: '촛농',
        description: '촛농. 중앙 식당의 식탁 위에 놓여 있었다.',
        flavorText: '왜 우미교는 전기를 안쓰고 촛불을 고집하는걸까?',
        type: 'normal',
        icon: '🪔',
    },
    item025: {
    ...
    npc_galchi_001: {
        id: 'npc_galchi_001',
        name: '신분증 (본인 거 아님)',
        description: '청갈치가 갖고 다니는 신분증. 사진은 비슷하지만 이름이 다르다. 도용된 것으로 보인다.',
        flavorText: '"이름이 뭐가 중요해. 중요한 건 믿게 만드는 거지."',
        type: 'key_item',
        icon: '🪪',
        npcOrigin: 'galchi',
    },
    npc_galchi_002: {
        id: 'npc_galchi_002',
        name: '개인 수첩',
        description: '사람 이름 대신 별명만 적혀 있다. "빨간코 아줌마 – 3200", "택시기사 – 1500". 금액으로 보이는 숫자와 날짜, 그리고 피해자들의 주민등록번호 메모가 빼곡하다.',
        flavorText: '피해자 기록장. 이 수첩에 적힌 사람들은 지금 어디에 있을까.',
        type: 'key_item',
        icon: '📓',
        npcOrigin: 'galchi',
    },
    ...
    npc_galchi_003: {
        id: 'npc_galchi_003',
        name: '찢어진 명함 뭉치와 신분증',
        description: '서로 다른 이름, 서로 다른 직함의 명함들. "한성민 – 투자 컨설턴트", "김도윤 – 해외 무역 담당", "박진우 – 재무설계사". 동일 인물이 여러 신분을 사용했다는 단서.',
        flavorText: '한 사람이 이 많은 얼굴을 갖고 있었다니.',
        type: 'key_item',
        icon: '🃏',
        npcOrigin: 'galchi',
        roomItem: true,
    ...
    npc_galchi_004: {
        id: 'npc_galchi_004',
        name: '여러 개의 휴대폰',
        description: '서로 다른 유심이 꽂힌 공기계 4대. 각각 다른 카카오톡 계정과 다른 사진들이 저장되어 있다. 연애 사기와 신분 위장의 흔적.',
        flavorText: '4개의 폰, 4개의 인생. 진짜는 어디에도 없다.',
        type: 'key_item',
        icon: '📱',
        npcOrigin: 'galchi',
        roomItem: true,
    ...
    npc_galchi_005: {
        id: 'npc_galchi_005',
        name: '선불폰 영수증 뭉치',
        description: '주기적으로 개통과 해지를 반복한 선불폰 영수증들. 추적을 회피하려는 목적이 분명하다.',
        flavorText: '한 번 쓰고 버리는 번호. 한 번 쓰고 버리는 관계.',
        type: 'normal',
        icon: '🧾',
        npcOrigin: 'galchi',
        roomItem: true,
    ...
    npc_galchi_006: {
        id: 'npc_galchi_006',
        name: '헌금 관리 장부 사본',
        description: '종교 시설 내부의 돈 흐름을 따로 정리한 장부. 과거 투자사기 장부와 동일한 포맷이다. 범죄 기술을 그대로 교단에 전이한 증거.',
